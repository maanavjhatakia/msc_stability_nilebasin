...
def generate_input_data(
    ...
    for district in nile_model.irr_districts.values():
        one_year = np.loadtxt(f"{file_path}IrrDemand{district.name}.txt")
    ...
    wheeler_large = pd.read_csv(f"{file_path}{wh_set}_wheeler.csv")
    ...
    atbara_dist = pd.read_csv(f"{file_path}atbara_distribution.csv")
    mogren_dist = pd.read_csv(f"{file_path}mogren_distribution.csv")
    bluenile_dist = pd.read_csv(f"{file_path}blue_nile_series.csv")
